...
title('AR Coefficients, mu = 0.05, gamma = 0.1','FontSize',title_font_size)
xlabel('n','FontSize',x_label_font_size)
ylabel('AR Coefficients','FontSize',y_label_font_size)
legend({'a_1','a_2'},'FontSize',legend_font_size)
axis([0 1000 0 0.9])
...
subplot(2,3,5)
plot(a_1_5_5_realisation_mean);
hold on
plot(a_2_5_5_realisation_mean);
title('AR Coefficients, mu = 0.05, gamma = 0.5','FontSize',title_font_size)
xlabel('n','FontSize',x_label_font_size)
ylabel('AR Coefficients','FontSize',y_label_font_size)
legend({'a_1','a_2'},'FontSize',legend_font_size)
axis([0 1000 0 0.9])
...
subplot(2,3,6)
plot(a_1_5_9_realisation_mean);
hold on
plot(a_2_5_9_realisation_mean);
title('AR Coefficients, mu = 0.01, gamma = 0.9','FontSize',title_font_size)
xlabel('n','FontSize',x_label_font_size)
ylabel('AR Coefficients','FontSize',y_label_font_size)
legend({'a_1','a_2'},'FontSize',legend_font_size)
